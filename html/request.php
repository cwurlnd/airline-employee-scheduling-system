...
if(isset($_POST["id"])){
    ...
    if ($_SESSION['title'] == 'p') {
        $sql = "INSERT INTO flys (pilot_id, flight_id, curr_status) VALUES (:pilot_id, :flight_id, :status)";
    } else {
        $sql = "INSERT INTO attends (fa_id, flight_id, curr_status) VALUES (:pilot_id, :flight_id, :status)";
    }
    ...
    oci_bind_by_name($stmt, ":status", $status = "P");
...
<body style="background-color:white;">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2>Request Flight</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert">
                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <p>Are you sure you want to request this flight?</p>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-success">
                                <a href="search-flights.php" class="btn btn-danger">No</a>
                            </p>
                        </div>
                    </form>
                </div>

        ...
        if($stmt){
            ...
            if(oci_execute($stmt)){
                ...
                if(oci_execute($user_id_stmt)){
                    ...
                    $admin_sql = "INSERT INTO flightattendants (user_id) VALUES (:user_id)";
...
<head>
    <meta charset="UTF-8">
    <title>Create Flight Attendant</title>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2>Sign Up</h2>
                    <p>Please fill this form to create a flight attendant account.</p>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <a href="adjust-employees.php" class="btn btn-danger ml-2">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>        

...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
        ...
        $sql = "SELECT p.user_id, u.first_name, u.email, u.password FROM flightattendants p, users u WHERE u.email = :email AND u.id = p.user_id AND u.password = :password";
